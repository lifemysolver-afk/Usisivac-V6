...
# ── Memoized Client Factories ───────────────────────────────────────────────
# Bolt ⚡: Memoize SDK client and HTTP session instantiations using lru_cache
# to eliminate redundant client initialization overhead (~36ms per call).
