...
# Shared HTTP session for Hugging Face API to reuse TCP/TLS connection pool
_hf_session = requests.Session()


# Bolt ⚡ Memoized SDK client factory functions to avoid instantiation overhead (~35ms per 100 calls)
