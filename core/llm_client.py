...
def _get_groq_client(api_key: str):
    """Bolt: Memoized Groq client to avoid ~35ms instantiation overhead."""
...
def _get_openai_client(api_key: str, base_url: str):
    """Bolt: Memoized OpenAI-compatible client to avoid ~32ms instantiation overhead."""
...
def _get_gemini_client(api_key: str):
    """Bolt: Memoized Gemini client to avoid ~95ms instantiation overhead."""
