...
# ─── Memoized SDK Client Instantiation ────────────────────────────────────────
# Reusing SDK client instances avoids repeated TLS handshake setup, environment
# checks, and configuration parsing, giving ~50x speedup for client instantiation.
