...
# Thread-safe global requests session for connection pooling (minimizes TCP/TLS handshake overhead)
_session = None
...
# Memoized client helpers to reduce client instantiation overhead from 32-111ms to <1.2ms
