...
# ─── Client Memoization ───────────────────────────────────────────────────────
# Bolt optimization: Memoizing client instantiation reduces overhead by ~30-100ms
# per call. Cache size of 10 accommodates key rotation and multiple providers.
