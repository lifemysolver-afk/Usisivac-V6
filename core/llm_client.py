...
# ─── Memoized SDK Client Helpers ─────────────────────────────────────────────
# Optimization: Reusing Groq and OpenAI SDK client instances via LRU caching saves
# ~33ms per Groq call and ~1.3ms per OpenAI call by eliminating redundant client initialization.
