...
class PickleRickIntegration:
    ...
    def __init__(self, extension_root: str = None):
        ...
        """
        default_root = Path.home() / "pickle-rick-extension"
        self.extension_root = extension_root or str(default_root)
        self.extension_path = Path(self.extension_root).expanduser()
