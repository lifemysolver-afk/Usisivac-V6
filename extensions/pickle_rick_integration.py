...
class PickleRickIntegration:
    ...
    def __init__(self, extension_root: str = None):
        ...
        """
        # ⚡ Bolt: Use relative path for portability (defaulting to home/pickle-rick-extension)
        self.extension_root = extension_root or str(Path.home() / "pickle-rick-extension")
