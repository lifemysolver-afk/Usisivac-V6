...
def test_exactly_quorum_of_3_passes():
    ...
    def _get_vote_fn(persona, persona_prompt, action, context):
        # We need exactly 3 PASS and 2 VETO.
        # LEGAL must be in the PASS votes to prevent the special LEGAL VETO rule.
        # Let's say CEO, CTO, and LEGAL PASS, while CFO and CRITIC VETO.
